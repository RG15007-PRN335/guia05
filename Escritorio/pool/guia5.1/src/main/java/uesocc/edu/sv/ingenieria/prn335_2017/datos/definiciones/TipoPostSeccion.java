 ...
 */
@Entity
@Table(name = "tipo_post_seccion", catalog = "posts2", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class TipoPostSeccion implements Serializable {
    ...
    public String toString() {
        return "ues.edu.sv.ingenieria.prn335_2017.datos.acceso.TipoPostSeccion[ tipoPostSeccionPK=" + tipoPostSeccionPK + " ]";
    }
