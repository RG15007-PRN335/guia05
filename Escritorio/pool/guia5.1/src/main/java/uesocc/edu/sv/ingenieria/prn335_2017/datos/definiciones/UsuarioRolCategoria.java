 ...
 */
package uesocc.edu.sv.ingenieria.prn335_2017.datos.definiciones;
 ...
 */
@Entity
@Table(name = "usuario_rol_categoria", catalog = "posts2", schema = "public")
@XmlRootElement
@NamedQueries({
...
public class UsuarioRolCategoria implements Serializable {
    ...
    public String toString() {
        return "ues.edu.sv.ingenieria.prn335_2017.datos.acceso.UsuarioRolCategoria[ usuarioRolCategoriaPK=" + usuarioRolCategoriaPK + " ]";
    }
